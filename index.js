...
function getFormattedTime(date) {
	...
	return getFormattedDay(date.getDate()) + " " + monthNames[date.getMonth()] + " " + date.getFullYear();
}

function lastUpdatedTimestampRefresh() {
	let date = new Date(document.lastModified);
	
	document.getElementById("LastUpdatedID").innerHTML = "Last updated " + getFormattedTime(date);
}
